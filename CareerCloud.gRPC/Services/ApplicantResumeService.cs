...
namespace CareerCloud.gRPC.Services
{
    public class ApplicantResumeService : ApplicantResumeBase
    {
        ...
        public override Task<ApplicantResumePayload> ReadApplicantResume(ApplicantResumeIdRequest request, ServerCallContext context)
        {
            ...
            return new Task<ApplicantResumePayload>(
                () => new ApplicantResumePayload()
                {
                    ...
                    Resume = poco.Resume,
                    LastUpdated = poco.LastUpdated is null ?
                        null :
                        Timestamp.FromDateTime((DateTime)poco.LastUpdated)
                });
        }
        ...
        public ApplicantResumePoco[] GetArray(ApplicantResumePayload request)
        {
